...
public class CreagteThumbnailAsyncTask extends AsyncTask<String, Void, Boolean> {

    private static final String TAG = CreagteThumbnailAsyncTask.class.getSimpleName();
    ...
    public CreagteThumbnailAsyncTask(CreateThumbnailCompleteListener createThumbnailCompleteListener) {
